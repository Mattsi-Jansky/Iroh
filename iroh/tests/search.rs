...
search_tests! {
    ...
    {discovered_check,"r3kb1r/ppq2ppp/2p5/3pN3/3P4/8/PPPQ1PPP/R3R1K1 w kq - 0 1","Ng6afaw"}
}

#[test]
fn discovered_check_2() {
let mut state = GameState::from_fen("r3kb1r/ppq2ppp/2p5/3pN3/3P4/8/PPPQ1PPP/R3R1K1 w kq - 0 1");

let result = search(&mut state);

assert_eq!(String::from("Ng6"), result.best_move);
}
