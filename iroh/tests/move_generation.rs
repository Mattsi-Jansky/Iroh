...
fn generate_moves_for_knight() {
    let game = GameInner::from_fen("8/8/8/4N3/8/8/8/8 w KQkq - 0 1").unwrap();
...
fn knight_moves_do_not_go_off_edge_of_board() {
    let game = GameInner::from_fen("8/8/8/8/8/8/8/N7 w KQkq - 0 1").unwrap();
...
fn generate_moves_for_king() {
    let game = GameInner::from_fen("8/8/8/4K3/8/8/8/8 w KQkq - 0 1").unwrap();
...
fn generate_moves_for_rook() {
    let game = GameInner::from_fen("8/8/8/4R3/8/8/8/8 w KQkq - 0 1").unwrap();
...
fn generate_moves_for_bishop() {
    let game = GameInner::from_fen("8/8/8/4B3/8/8/8/8 w KQkq - 0 1").unwrap();
...
fn generate_moves_for_queen() {
    let game = GameInner::from_fen("8/8/8/4Q3/8/8/8/8 w KQkq - 0 1").unwrap();
...
fn pawn_attack_moves() {
    let game = GameInner::from_fen("8/8/2p1p3/3P4/8/8/8/8 w KQkq - 0 1").unwrap();
