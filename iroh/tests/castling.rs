...
fn given_first_player_should_castle_kingside() {
    ...
    assert_eq!("rnbqk1nr/ppp1bppp/3p4/4p3/4P3/3B1N2/PPPP1PPP/RNBQ1RK1 b kq - 0 1", game.generate_fen().unwrap());
}
...
fn given_first_player_and_rook_not_in_place_cannot_castle_kingside() {
    ...
    game = game.make_move("Rg1");
    game = game.make_move("h6");
    let result = game.make_move("O-O");
...
fn given_first_player_and_rook_has_moved_cannot_castle_kingside() {
    ...
    game = game.make_move("Rg1");
    game = game.make_move("a6");
    game = game.make_move("Rh1");
    game = game.make_move("b6");
    let result = game.make_move("O-O");
...
fn given_first_player_and_king_has_moved_cannot_castle_kingside() {
    ...
    game = game.make_move("Kf1");
    game = game.make_move("a6");
    game = game.make_move("Ke1");
    game = game.make_move("b6");
    let result = game.make_move("O-O");
...
fn given_first_player_should_castle_queenside() {
    ...
    assert_eq!("r1bqk2r/ppp2ppp/2nb1n2/3pp3/8/1PN1PQ2/PBPP1PPP/2KR1BNR b kq - 0 1", game.generate_fen().unwrap());
}
...
fn given_second_player_should_castle_kingside() {
    ...
    assert_eq!("rnbq1rk1/ppppbppp/4pn2/8/3PP3/2N2N2/PPP2PPP/R1BQKB1R w KQ - 0 1", game.generate_fen().unwrap());
}
...
fn given_second_player_and_rook_has_moved_cannot_castle_kingside() {
    ...
    game = game.make_move("Rg8");
    game = game.make_move("e5");
    game = game.make_move("Rh8");
    game = game.make_move("a3");
    let result = game.make_move("O-O");
...
fn given_second_player_and_king_has_moved_cannot_castle_kingside() {
    ...
    game = game.make_move("e4");
    game = game.make_move("Kf8");
    game = game.make_move("e5");
    game = game.make_move("Ke8");
    game = game.make_move("a3");
    let result = game.make_move("O-O");
...
fn given_second_player_should_castle_queenside() {
    ...
    assert_eq!("2kr1bnr/pbpp1ppp/1pn1pq2/8/3PP3/P1NB1N2/1PP2PPP/R1BQK2R w KQ - 0 1", game.generate_fen().unwrap());
}
...
fn given_second_player_and_rook_has_moved_cannot_castle_queenside() {
    ...
    game = game.make_move("Rb8");
    game = game.make_move("a4");
    game = game.make_move("Ra8");
    game = game.make_move("b3");
    let result = game.make_move("O-O-O");
