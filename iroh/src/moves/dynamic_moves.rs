...
// fn generate_dynamic_moves(game_state: &GameState, available_moves: &mut Vec<Move>, from_tile: (Tile, Coordinate), transformations: &[(isize, isize)], is_for_first_player: bool) {
